================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: InputTest プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した InputTest には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには InputTest アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
InputTest.h
   ...
   CInputTestApp アプリケーション クラスを宣言します。

InputTest.cpp
   これは、アプリケーション クラス CInputTestApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\InputTest.ico
   ...
   アイコンはメイン リソース ファイル InputTest.rc に含まれていま
   す。
...
InputTestDlg.h, InputTestDlg.cpp - ダイアログ
   これらのファイルは CInputTestDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な InputTest.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   InputTest.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
