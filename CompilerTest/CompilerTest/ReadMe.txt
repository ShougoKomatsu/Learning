...
================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: CompilerTest プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した CompilerTest には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには CompilerTest アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

CompilerTest.vcxproj
...
CompilerTest.h
   ...
   CCompilerTestApp アプリケーション クラスを宣言します。

CompilerTest.cpp
   これは、アプリケーション クラス CCompilerTestApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\CompilerTest.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル CompilerTest.rc に含まれていま
   す。

res\CompilerTest.rc2
...
CompilerTestDlg.h, CompilerTestDlg.cpp - ダイアログ
   これらのファイルは CCompilerTestDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な CompilerTest.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   CompilerTest.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
